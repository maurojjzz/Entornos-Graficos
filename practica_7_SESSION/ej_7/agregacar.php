<?php
    ...
    //cuando la cantidad no esta indicada, no se seleccionaron anteriormente productos para el carrito, la cantidad de debe ser 1.
    ...
    //Si ya hemos introducido algun producto en el carro lo tendremos guardado temporalmente en el array superglobal $_SESSION['carro'], de manera que rescatamos los valores de dicho array y se los asignamos a la variable $carro, previa comprobacion con isset de que $_SESSION['carro'] ya haya sido definida
    ...
    // teníamos (si es que teníamos alguno) antes de ingresar a esta página y en la variable
    // $carro tenemos esos mismos valores más el que acabamos de sumar. De manera que
    // tenemos que actualizar (reemplazar) la variable de sesión por la variable $carro.

    $_SESSION['carro']=$carro;
    
    //La cadena SID representa al identificador de la sesión, que, dependiendo
    // de la configuración del servidor y de si el usuario tiene o no activadas las cookies puede
