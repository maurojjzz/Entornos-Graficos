<?php
    //con session_start() creamos la sesion si no existe o la retomamos si ya ha sido creada
    session_start();
    ...
    // //Finalmente, actualizamos la sessión, como hicimos cuando agregamos un producto y
